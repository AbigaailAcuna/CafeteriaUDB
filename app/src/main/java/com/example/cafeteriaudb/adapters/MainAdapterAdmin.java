    ...
    public void onBindViewHolder(@NonNull MainAdapterAdmin.MyViewHolder holder, int position) {
        ...
        holder.btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Pasar datos del platillo a la actividad de edición
                intent.putExtra("nombrePlato", model.getPlato());
                intent.putExtra("descripcionPlato", model.getDescripcion());
                intent.putExtra("precioPlato", model.getPrecio());
                intent.putExtra("diaPlato", model.getDia());
                intent.putExtra("imagenPlato", model.getImagen());
                intent.putExtra("categoria", category);
                // Puedes pasar más datos según necesites
